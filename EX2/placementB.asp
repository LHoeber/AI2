...
% counts the ligthbulbs, that are directly adjecent to the wall
adjecentBulbs(WR,WC,N) :- wall(WR,WC,_),
                        N = #count { R,C : placeLightBulb(R,C), neighbouringWallCell(WR,WC,R,C) }.
                        
% the amount af lightbulbs adjecent to a wall, can't exceed the walls capacity
:- wall(WR,WC,K), adjecentBulbs(WR,WC,N), N > K.
